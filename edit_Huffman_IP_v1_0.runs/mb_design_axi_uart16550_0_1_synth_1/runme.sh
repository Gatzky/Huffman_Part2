...
HD_PWD='C:/Gac/Projekty/Huffman_Part2/edit_Huffman_IP_v1_0.runs/mb_design_axi_uart16550_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_axi_uart16550_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_axi_uart16550_0_1.tcl
