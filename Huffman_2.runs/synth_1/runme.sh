...
HD_PWD='C:/Gac/Projekty/Huffman_2/Huffman_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SynthHuffman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SynthHuffman.tcl
