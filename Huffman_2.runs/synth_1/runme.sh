...
HD_PWD='C:/Gac/Projekty/Huffman_Part2/Huffman_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log huffman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source huffman.tcl
