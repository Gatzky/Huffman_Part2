...
//Command     : generate_target Huffman_On_Ip.bd
//Design      : Huffman_On_Ip
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "Huffman_On_Ip,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Huffman_On_Ip,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=5,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Huffman_On_Ip.hwdef" *) 
module Huffman_On_Ip
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 BAUDOUTn" *) output uart_rtl_1_baudoutn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 CTSn" *) input uart_rtl_1_ctsn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 DCDn" *) input uart_rtl_1_dcdn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 DDIS" *) output uart_rtl_1_ddis;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 DSRn" *) input uart_rtl_1_dsrn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 DTRn" *) output uart_rtl_1_dtrn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 OUT1n" *) output uart_rtl_1_out1n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 OUT2n" *) output uart_rtl_1_out2n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 RI" *) input uart_rtl_1_ri;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 RTSn" *) output uart_rtl_1_rtsn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 RxD" *) input uart_rtl_1_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 RXRDYn" *) output uart_rtl_1_rxrdyn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 TxD" *) output uart_rtl_1_txd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 uart_rtl_1 TXRDYn" *) output uart_rtl_1_txrdyn;
  ...
  assign axi_uart16550_1_UART_CTSn = uart_rtl_1_ctsn;
  assign axi_uart16550_1_UART_DCDn = uart_rtl_1_dcdn;
  assign axi_uart16550_1_UART_DSRn = uart_rtl_1_dsrn;
  assign axi_uart16550_1_UART_RI = uart_rtl_1_ri;
  assign axi_uart16550_1_UART_RxD = uart_rtl_1_rxd;
  ...
  assign uart_rtl_1_baudoutn = axi_uart16550_1_UART_BAUDOUTn;
  assign uart_rtl_1_ddis = axi_uart16550_1_UART_DDIS;
  assign uart_rtl_1_dtrn = axi_uart16550_1_UART_DTRn;
  assign uart_rtl_1_out1n = axi_uart16550_1_UART_OUT1n;
  assign uart_rtl_1_out2n = axi_uart16550_1_UART_OUT2n;
  assign uart_rtl_1_rtsn = axi_uart16550_1_UART_RTSn;
  assign uart_rtl_1_rxrdyn = axi_uart16550_1_UART_RXRDYn;
  assign uart_rtl_1_txd = axi_uart16550_1_UART_TxD;
  assign uart_rtl_1_txrdyn = axi_uart16550_1_UART_TXRDYn;
  Huffman_On_Ip_HuffmanAXI_0_0 HuffmanAXI_0
  ...
  Huffman_On_Ip_axi_uart16550_0_0 axi_uart16550_0
  ...
  Huffman_On_Ip_axi_uart16550_1_0 axi_uart16550_1
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > Huffman_On_Ip microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Huffman_On_Ip_microblaze_0_0 microblaze_0
  ...
  Huffman_On_Ip_microblaze_0_axi_periph_0 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_I0GUBU microblaze_0_local_memory
  ...
  Huffman_On_Ip_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module Huffman_On_Ip_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_17L5OOX m00_couplers
  ...
  m01_couplers_imp_1RU8WL m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  m02_couplers_imp_V7RW6G m02_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_10ANI2M s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
...
module m00_couplers_imp_17L5OOX
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
module m01_couplers_imp_1RU8WL
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_V7RW6G
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_I0GUBU
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > Huffman_On_Ip microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  Huffman_On_Ip_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  Huffman_On_Ip_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  Huffman_On_Ip_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  Huffman_On_Ip_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  Huffman_On_Ip_lmb_bram_0 lmb_bram
...
module s00_couplers_imp_10ANI2M
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
