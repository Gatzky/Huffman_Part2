...
module HuffmanCoder(clock, inputData, dataEnable, outputData, outputProbabilityList, dataReady, codeMapReady);
...
parameter INIT =  4'b0001, GET_DATA =  4'b0002, BUILD_TREE =  4'b0003, SEND_TREE =  4'b0004;
